...
pub mod text_segmentation {
    ...
    static cluster_boundary_table : &'static [[bool, ..13]] = &[
    ...
    static break_property_table : &'static [(char, char, u8)] = &[
        ('\x00', '\x09', Control as u8),
        ('\x0a', '\x0a', LF as u8),
        ('\x0b', '\x0c', Control as u8),
        ('\x0d', '\x0d', CR as u8),
        ('\x0e', '\x1f', Control as u8),
        ('\x7f', '\x9f', Control as u8),
        ('\xad', '\xad', Control as u8),
        ('\u0300', '\u036f', Extend as u8),
        ('\u0483', '\u0487', Extend as u8),
        ('\u0488', '\u0489', Extend as u8),
        ('\u0591', '\u05bd', Extend as u8),
        ...
        ('\u08e4', '\u08fe', Extend as u8),
        ('\u0900', '\u0902', Extend as u8),
        ('\u0903', '\u0903', SpacingMark as u8),
        ('\u093a', '\u093a', Extend as u8),
        ('\u093b', '\u093b', SpacingMark as u8),
        ('\u093c', '\u093c', Extend as u8),
        ('\u093e', '\u0940', SpacingMark as u8),
        ('\u0941', '\u0948', Extend as u8),
        ('\u0949', '\u094c', SpacingMark as u8),
        ('\u094d', '\u094d', Extend as u8),
        ('\u094e', '\u094f', SpacingMark as u8),
        ('\u0951', '\u0957', Extend as u8),
        ('\u0962', '\u0963', Extend as u8),
        ('\u0981', '\u0981', Extend as u8),
        ('\u0982', '\u0983', SpacingMark as u8),
        ('\u09bc', '\u09bc', Extend as u8),
        ('\u09be', '\u09be', Extend as u8),
        ('\u09bf', '\u09c0', SpacingMark as u8),
        ('\u09c1', '\u09c4', Extend as u8),
        ('\u09c7', '\u09c8', SpacingMark as u8),
        ('\u09cb', '\u09cc', SpacingMark as u8),
        ('\u09cd', '\u09cd', Extend as u8),
        ('\u09d7', '\u09d7', Extend as u8),
        ('\u09e2', '\u09e3', Extend as u8),
        ('\u0a01', '\u0a02', Extend as u8),
        ('\u0a03', '\u0a03', SpacingMark as u8),
        ('\u0a3c', '\u0a3c', Extend as u8),
        ('\u0a3e', '\u0a40', SpacingMark as u8),
        ('\u0a41', '\u0a42', Extend as u8),
        ('\u0a47', '\u0a48', Extend as u8),
        ('\u0a4b', '\u0a4d', Extend as u8),
        ('\u0a51', '\u0a51', Extend as u8),
        ...
        ('\u0a75', '\u0a75', Extend as u8),
        ('\u0a81', '\u0a82', Extend as u8),
        ('\u0a83', '\u0a83', SpacingMark as u8),
        ('\u0abc', '\u0abc', Extend as u8),
        ('\u0abe', '\u0ac0', SpacingMark as u8),
        ('\u0ac1', '\u0ac5', Extend as u8),
        ('\u0ac7', '\u0ac8', Extend as u8),
        ('\u0ac9', '\u0ac9', SpacingMark as u8),
        ('\u0acb', '\u0acc', SpacingMark as u8),
        ('\u0acd', '\u0acd', Extend as u8),
        ('\u0ae2', '\u0ae3', Extend as u8),
        ('\u0b01', '\u0b01', Extend as u8),
        ('\u0b02', '\u0b03', SpacingMark as u8),
        ('\u0b3c', '\u0b3c', Extend as u8),
        ('\u0b3e', '\u0b3e', Extend as u8),
        ('\u0b3f', '\u0b3f', Extend as u8),
        ('\u0b40', '\u0b40', SpacingMark as u8),
        ('\u0b41', '\u0b44', Extend as u8),
        ('\u0b47', '\u0b48', SpacingMark as u8),
        ('\u0b4b', '\u0b4c', SpacingMark as u8),
        ('\u0b4d', '\u0b4d', Extend as u8),
        ('\u0b56', '\u0b56', Extend as u8),
        ('\u0b57', '\u0b57', Extend as u8),
        ('\u0b62', '\u0b63', Extend as u8),
        ('\u0b82', '\u0b82', Extend as u8),
        ('\u0bbe', '\u0bbe', Extend as u8),
        ('\u0bbf', '\u0bbf', SpacingMark as u8),
        ('\u0bc0', '\u0bc0', Extend as u8),
        ('\u0bc1', '\u0bc2', SpacingMark as u8),
        ('\u0bc6', '\u0bc8', SpacingMark as u8),
        ('\u0bca', '\u0bcc', SpacingMark as u8),
        ('\u0bcd', '\u0bcd', Extend as u8),
        ('\u0bd7', '\u0bd7', Extend as u8),
        ('\u0c01', '\u0c03', SpacingMark as u8),
        ('\u0c3e', '\u0c40', Extend as u8),
        ('\u0c41', '\u0c44', SpacingMark as u8),
        ('\u0c46', '\u0c48', Extend as u8),
        ('\u0c4a', '\u0c4d', Extend as u8),
        ('\u0c55', '\u0c56', Extend as u8),
        ('\u0c62', '\u0c63', Extend as u8),
        ('\u0c82', '\u0c83', SpacingMark as u8),
        ('\u0cbc', '\u0cbc', Extend as u8),
        ('\u0cbe', '\u0cbe', SpacingMark as u8),
        ('\u0cbf', '\u0cbf', Extend as u8),
        ('\u0cc0', '\u0cc1', SpacingMark as u8),
        ('\u0cc2', '\u0cc2', Extend as u8),
        ('\u0cc3', '\u0cc4', SpacingMark as u8),
        ('\u0cc6', '\u0cc6', Extend as u8),
        ('\u0cc7', '\u0cc8', SpacingMark as u8),
        ('\u0cca', '\u0ccb', SpacingMark as u8),
        ('\u0ccc', '\u0ccd', Extend as u8),
        ('\u0cd5', '\u0cd6', Extend as u8),
        ('\u0ce2', '\u0ce3', Extend as u8),
        ('\u0d02', '\u0d03', SpacingMark as u8),
        ('\u0d3e', '\u0d3e', Extend as u8),
        ('\u0d3f', '\u0d40', SpacingMark as u8),
        ('\u0d41', '\u0d44', Extend as u8),
        ('\u0d46', '\u0d48', SpacingMark as u8),
        ('\u0d4a', '\u0d4c', SpacingMark as u8),
        ('\u0d4d', '\u0d4d', Extend as u8),
        ('\u0d57', '\u0d57', Extend as u8),
        ('\u0d62', '\u0d63', Extend as u8),
        ('\u0d82', '\u0d83', SpacingMark as u8),
        ('\u0dca', '\u0dca', Extend as u8),
        ('\u0dcf', '\u0dcf', Extend as u8),
        ('\u0dd0', '\u0dd1', SpacingMark as u8),
        ('\u0dd2', '\u0dd4', Extend as u8),
        ('\u0dd6', '\u0dd6', Extend as u8),
        ('\u0dd8', '\u0dde', SpacingMark as u8),
        ('\u0ddf', '\u0ddf', Extend as u8),
        ('\u0df2', '\u0df3', SpacingMark as u8),
        ('\u0e31', '\u0e31', Extend as u8),
        ('\u0e33', '\u0e33', SpacingMark as u8),
        ('\u0e34', '\u0e3a', Extend as u8),
        ('\u0e47', '\u0e4e', Extend as u8),
        ('\u0eb1', '\u0eb1', Extend as u8),
        ('\u0eb3', '\u0eb3', SpacingMark as u8),
        ('\u0eb4', '\u0eb9', Extend as u8),
        ('\u0ebb', '\u0ebc', Extend as u8),
        ('\u0ec8', '\u0ecd', Extend as u8),
        ('\u0f18', '\u0f19', Extend as u8),
        ...
        ('\u0f37', '\u0f37', Extend as u8),
        ('\u0f39', '\u0f39', Extend as u8),
        ('\u0f3e', '\u0f3f', SpacingMark as u8),
        ('\u0f71', '\u0f7e', Extend as u8),
        ('\u0f7f', '\u0f7f', SpacingMark as u8),
        ('\u0f80', '\u0f84', Extend as u8),
        ('\u0f86', '\u0f87', Extend as u8),
        ('\u0f8d', '\u0f97', Extend as u8),
        ('\u0f99', '\u0fbc', Extend as u8),
        ('\u0fc6', '\u0fc6', Extend as u8),
        ('\u102d', '\u1030', Extend as u8),
        ('\u1031', '\u1031', SpacingMark as u8),
        ('\u1032', '\u1037', Extend as u8),
        ('\u1039', '\u103a', Extend as u8),
        ('\u103b', '\u103c', SpacingMark as u8),
        ('\u103d', '\u103e', Extend as u8),
        ('\u1056', '\u1057', SpacingMark as u8),
        ('\u1058', '\u1059', Extend as u8),
        ('\u105e', '\u1060', Extend as u8),
        ('\u1071', '\u1074', Extend as u8),
        ('\u1082', '\u1082', Extend as u8),
        ('\u1084', '\u1084', SpacingMark as u8),
        ('\u1085', '\u1086', Extend as u8),
        ('\u108d', '\u108d', Extend as u8),
        ('\u109d', '\u109d', Extend as u8),
        ('\u1100', '\u115f', L as u8),
        ...
        ('\u1772', '\u1773', Extend as u8),
        ('\u17b4', '\u17b5', Extend as u8),
        ('\u17b6', '\u17b6', SpacingMark as u8),
        ('\u17b7', '\u17bd', Extend as u8),
        ('\u17be', '\u17c5', SpacingMark as u8),
        ('\u17c6', '\u17c6', Extend as u8),
        ('\u17c7', '\u17c8', SpacingMark as u8),
        ('\u17c9', '\u17d3', Extend as u8),
        ('\u17dd', '\u17dd', Extend as u8),
        ('\u180b', '\u180d', Extend as u8),
        ('\u180e', '\u180e', Control as u8),
        ('\u18a9', '\u18a9', Extend as u8),
        ('\u1920', '\u1922', Extend as u8),
        ('\u1923', '\u1926', SpacingMark as u8),
        ('\u1927', '\u1928', Extend as u8),
        ('\u1929', '\u192b', SpacingMark as u8),
        ('\u1930', '\u1931', SpacingMark as u8),
        ('\u1932', '\u1932', Extend as u8),
        ('\u1933', '\u1938', SpacingMark as u8),
        ('\u1939', '\u193b', Extend as u8),
        ('\u19b5', '\u19b7', SpacingMark as u8),
        ('\u19ba', '\u19ba', SpacingMark as u8),
        ('\u1a17', '\u1a18', Extend as u8),
        ('\u1a19', '\u1a1a', SpacingMark as u8),
        ('\u1a1b', '\u1a1b', Extend as u8),
        ('\u1a55', '\u1a55', SpacingMark as u8),
        ('\u1a56', '\u1a56', Extend as u8),
        ('\u1a57', '\u1a57', SpacingMark as u8),
        ('\u1a58', '\u1a5e', Extend as u8),
        ('\u1a60', '\u1a60', Extend as u8),
        ('\u1a62', '\u1a62', Extend as u8),
        ('\u1a65', '\u1a6c', Extend as u8),
        ('\u1a6d', '\u1a72', SpacingMark as u8),
        ('\u1a73', '\u1a7c', Extend as u8),
        ('\u1a7f', '\u1a7f', Extend as u8),
        ('\u1b00', '\u1b03', Extend as u8),
        ('\u1b04', '\u1b04', SpacingMark as u8),
        ('\u1b34', '\u1b34', Extend as u8),
        ('\u1b35', '\u1b35', SpacingMark as u8),
        ('\u1b36', '\u1b3a', Extend as u8),
        ('\u1b3b', '\u1b3b', SpacingMark as u8),
        ('\u1b3c', '\u1b3c', Extend as u8),
        ('\u1b3d', '\u1b41', SpacingMark as u8),
        ('\u1b42', '\u1b42', Extend as u8),
        ('\u1b43', '\u1b44', SpacingMark as u8),
        ('\u1b6b', '\u1b73', Extend as u8),
        ('\u1b80', '\u1b81', Extend as u8),
        ('\u1b82', '\u1b82', SpacingMark as u8),
        ('\u1ba1', '\u1ba1', SpacingMark as u8),
        ('\u1ba2', '\u1ba5', Extend as u8),
        ('\u1ba6', '\u1ba7', SpacingMark as u8),
        ('\u1ba8', '\u1ba9', Extend as u8),
        ('\u1baa', '\u1baa', SpacingMark as u8),
        ('\u1bab', '\u1bab', Extend as u8),
        ('\u1bac', '\u1bad', SpacingMark as u8),
        ('\u1be6', '\u1be6', Extend as u8),
        ('\u1be7', '\u1be7', SpacingMark as u8),
        ('\u1be8', '\u1be9', Extend as u8),
        ('\u1bea', '\u1bec', SpacingMark as u8),
        ('\u1bed', '\u1bed', Extend as u8),
        ('\u1bee', '\u1bee', SpacingMark as u8),
        ('\u1bef', '\u1bf1', Extend as u8),
        ('\u1bf2', '\u1bf3', SpacingMark as u8),
        ('\u1c24', '\u1c2b', SpacingMark as u8),
        ('\u1c2c', '\u1c33', Extend as u8),
        ('\u1c34', '\u1c35', SpacingMark as u8),
        ('\u1c36', '\u1c37', Extend as u8),
        ('\u1cd0', '\u1cd2', Extend as u8),
        ('\u1cd4', '\u1ce0', Extend as u8),
        ('\u1ce1', '\u1ce1', SpacingMark as u8),
        ('\u1ce2', '\u1ce8', Extend as u8),
        ('\u1ced', '\u1ced', Extend as u8),
        ('\u1cf2', '\u1cf3', SpacingMark as u8),
        ('\u1cf4', '\u1cf4', Extend as u8),
        ('\u1dc0', '\u1de6', Extend as u8),
        ('\u1dfc', '\u1dff', Extend as u8),
        ('\u200b', '\u200b', Control as u8),
        ...
        ('\ua806', '\ua806', Extend as u8),
        ('\ua80b', '\ua80b', Extend as u8),
        ('\ua823', '\ua824', SpacingMark as u8),
        ('\ua825', '\ua826', Extend as u8),
        ('\ua827', '\ua827', SpacingMark as u8),
        ('\ua880', '\ua881', SpacingMark as u8),
        ('\ua8b4', '\ua8c3', SpacingMark as u8),
        ('\ua8c4', '\ua8c4', Extend as u8),
        ('\ua8e0', '\ua8f1', Extend as u8),
        ('\ua926', '\ua92d', Extend as u8),
        ('\ua947', '\ua951', Extend as u8),
        ('\ua952', '\ua953', SpacingMark as u8),
        ('\ua960', '\ua97c', L as u8),
        ('\ua980', '\ua982', Extend as u8),
        ('\ua983', '\ua983', SpacingMark as u8),
        ('\ua9b3', '\ua9b3', Extend as u8),
        ('\ua9b4', '\ua9b5', SpacingMark as u8),
        ('\ua9b6', '\ua9b9', Extend as u8),
        ('\ua9ba', '\ua9bb', SpacingMark as u8),
        ('\ua9bc', '\ua9bc', Extend as u8),
        ('\ua9bd', '\ua9c0', SpacingMark as u8),
        ('\uaa29', '\uaa2e', Extend as u8),
        ('\uaa2f', '\uaa30', SpacingMark as u8),
        ('\uaa31', '\uaa32', Extend as u8),
        ('\uaa33', '\uaa34', SpacingMark as u8),
        ('\uaa35', '\uaa36', Extend as u8),
        ('\uaa43', '\uaa43', Extend as u8),
        ('\uaa4c', '\uaa4c', Extend as u8),
        ('\uaa4d', '\uaa4d', SpacingMark as u8),
        ('\uaab0', '\uaab0', Extend as u8),
        ('\uaab2', '\uaab4', Extend as u8),
        ('\uaab7', '\uaab8', Extend as u8),
        ('\uaabe', '\uaabf', Extend as u8),
        ('\uaac1', '\uaac1', Extend as u8),
        ('\uaaeb', '\uaaeb', SpacingMark as u8),
        ('\uaaec', '\uaaed', Extend as u8),
        ('\uaaee', '\uaaef', SpacingMark as u8),
        ('\uaaf5', '\uaaf5', SpacingMark as u8),
        ('\uaaf6', '\uaaf6', Extend as u8),
        ('\uabe3', '\uabe4', SpacingMark as u8),
        ('\uabe5', '\uabe5', Extend as u8),
        ('\uabe6', '\uabe7', SpacingMark as u8),
        ('\uabe8', '\uabe8', Extend as u8),
        ('\uabe9', '\uabea', SpacingMark as u8),
        ('\uabec', '\uabec', SpacingMark as u8),
        ('\uabed', '\uabed', Extend as u8),
        ('\uac00', '\uac00', LV as u8),
        ('\uac01', '\uac1b', LVT as u8),
        ('\uac1c', '\uac1c', LV as u8),
        ...
        ('\ufff0', '\ufff8', Control as u8),
        ('\ufff9', '\ufffb', Control as u8),
        ('\U000101fd', '\U000101fd', Extend as u8),
        ('\U00010a01', '\U00010a03', Extend as u8),
        ('\U00010a05', '\U00010a06', Extend as u8),
        ('\U00010a0c', '\U00010a0f', Extend as u8),
        ('\U00010a38', '\U00010a3a', Extend as u8),
        ('\U00010a3f', '\U00010a3f', Extend as u8),
        ('\U00011000', '\U00011000', SpacingMark as u8),
        ('\U00011001', '\U00011001', Extend as u8),
        ('\U00011002', '\U00011002', SpacingMark as u8),
        ('\U00011038', '\U00011046', Extend as u8),
        ('\U00011080', '\U00011081', Extend as u8),
        ('\U00011082', '\U00011082', SpacingMark as u8),
        ('\U000110b0', '\U000110b2', SpacingMark as u8),
        ('\U000110b3', '\U000110b6', Extend as u8),
        ('\U000110b7', '\U000110b8', SpacingMark as u8),
        ('\U000110b9', '\U000110ba', Extend as u8),
        ('\U000110bd', '\U000110bd', Control as u8),
        ('\U00011100', '\U00011102', Extend as u8),
        ('\U00011127', '\U0001112b', Extend as u8),
        ('\U0001112c', '\U0001112c', SpacingMark as u8),
        ('\U0001112d', '\U00011134', Extend as u8),
        ('\U00011180', '\U00011181', Extend as u8),
        ('\U00011182', '\U00011182', SpacingMark as u8),
        ('\U000111b3', '\U000111b5', SpacingMark as u8),
        ('\U000111b6', '\U000111be', Extend as u8),
        ('\U000111bf', '\U000111c0', SpacingMark as u8),
        ('\U000116ab', '\U000116ab', Extend as u8),
        ('\U000116ac', '\U000116ac', SpacingMark as u8),
        ('\U000116ad', '\U000116ad', Extend as u8),
        ('\U000116ae', '\U000116af', SpacingMark as u8),
        ('\U000116b0', '\U000116b5', Extend as u8),
        ('\U000116b6', '\U000116b6', SpacingMark as u8),
        ('\U000116b7', '\U000116b7', Extend as u8),
        ('\U00016f51', '\U00016f7e', SpacingMark as u8),
        ('\U00016f8f', '\U00016f92', Extend as u8),
        ('\U0001d165', '\U0001d165', Extend as u8),
        ('\U0001d166', '\U0001d166', SpacingMark as u8),
        ('\U0001d167', '\U0001d169', Extend as u8),
        ('\U0001d16d', '\U0001d16d', SpacingMark as u8),
        ('\U0001d16e', '\U0001d172', Extend as u8),
        ('\U0001d173', '\U0001d17a', Control as u8),
        ('\U0001d17b', '\U0001d182', Extend as u8),
        ('\U0001d185', '\U0001d18b', Extend as u8),
        ('\U0001d1aa', '\U0001d1ad', Extend as u8),
        ('\U0001d242', '\U0001d244', Extend as u8),
        ('\U0001f1e6', '\U0001f1ff', Regional_Indicator as u8),
        ('\U000e0000', '\U000e0000', Control as u8),
        ('\U000e0001', '\U000e0001', Control as u8),
        ('\U000e0002', '\U000e001f', Control as u8),
        ('\U000e0020', '\U000e007f', Control as u8),
        ('\U000e0080', '\U000e00ff', Control as u8),
        ('\U000e0100', '\U000e01ef', Extend as u8),
        ('\U000e01f0', '\U000e0fff', Control as u8),
    ];

    fn break_property(c: char) -> u8 {
        super::bsearch_range_value_table(c, break_property_table)
    }

    pub fn cluster_boundary(c1: char, c2: char) -> bool {
        let p1 = break_property(c1) as uint;
        let p2 = break_property(c2) as uint;
        cluster_boundary_table[p1][p2]
    }
